### kubler/kibana:20200131

Built: Fri 31 Jan 2020 03:07:36 PM CET
Image Size: 346MB
...
www-apps/kibana-bin-7.5.1 | `-x-pack`
#### Inherited
Package | USE Flags
--------|----------
**FROM kubler/nodejs** |
...
net-libs/nodejs-12.14.0 | `icu npm snapshot ssl -debug -doc -inspector -systemtap -test`
