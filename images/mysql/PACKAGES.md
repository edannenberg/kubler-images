### kubler/mysql:20230131

Built: Wed Feb  1 12:22:33 AM CET 2023
Image Size: 365MB
...
dev-db/mysql-8.0.31-r1 | `server -cjk -cracklib -debug -jemalloc -latin1 -numa -perl -profiling -router (-selinux) -tcmalloc -test`
