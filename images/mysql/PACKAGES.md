### kubler/mysql:20240630

Built: Sat Jul 20 04:24:36 AM CEST 2024
Image Size: 353MB
...
dev-db/mysql-8.0.36 | `server -cjk -cracklib -debug -jemalloc -latin1 -numa -perl -profiling -router (-selinux) -tcmalloc -test`
...
net-libs/libtirpc-1.3.4-r2 | `-kerberos -static-libs`
sys-process/procps-4.0.4-r1 | `kill nls (unicode) -elogind -modern-top -ncurses (-selinux) -static-libs -systemd -test`
