### kubler/mysql:20230330

Built: Thu Mar 30 09:14:15 AM CEST 2023
Image Size: 365MB
...
dev-db/mysql-8.0.31-r2 | `server -cjk -cracklib -debug -jemalloc -latin1 -numa -perl -profiling -router (-selinux) -tcmalloc -test`
