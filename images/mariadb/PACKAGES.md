### kubler/mariadb:20210530

Built: Sun May 30 05:24:59 PM CEST 2021
Image Size: 443MB
...
dev-db/mariadb-10.5.9-r5 | `backup bindist perl server -columnstore -cracklib -debug -extraengine -galera -innodb-lz4 -innodb-lzo -innodb-snappy -jdbc -jemalloc -kerberos -latin1 (-mroonga) -numa -odbc -oqgraph -pam -profiling -rocksdb -s3 (-selinux) -sphinx -sst-mariabackup -sst-rsync -static -systemd -systemtap -tcmalloc -test -xml -yassl`
...
dev-lang/python-3.8.9_p2 | `hardened readline sqlite ssl xml -bluetooth -build -examples -gdbm -ipv6 -ncurses -test -tk -verify-sig -wininst`
