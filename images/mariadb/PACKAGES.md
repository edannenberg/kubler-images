### kubler/mariadb:20221231

Built: Fri Jan  6 08:59:54 PM CET 2023
Image Size: 482MB
...
dev-db/mariadb-10.6.10 | `backup bindist perl server -columnstore -cracklib -debug -extraengine -galera -innodb-lz4 -innodb-lzo -innodb-snappy -jdbc -jemalloc -kerberos -latin1 (-mroonga) -numa -odbc -oqgraph -pam -profiling -rocksdb -s3 (-selinux) -sphinx -sst-mariabackup -sst-rsync -static -systemd -systemtap -tcmalloc -test -xml -yassl`
...
dev-lang/python-3.10.9 | `ensurepip hardened readline sqlite ssl xml -bluetooth -build -examples -gdbm -libedit -lto -ncurses -pgo -test -tk -valgrind -verify-sig`
...
sys-apps/systemd-utils-251.10 | `acl kmod (split-usr) tmpfiles udev -boot (-selinux) -sysusers -test`
