### kubler/nginx-php7:20210630

Built: Wed Jun 30 08:55:31 AM CEST 2021
Image Size: 134MB
...
media-gfx/imagemagick-7.1.0.0 | `bzip2 cxx jpeg jpeg2k png tiff webp zlib -`
...
--------|----------
**FROM kubler/nginx** |
www-servers/nginx-1.21.0-r2 | `http http-cache http2 pcre ssl threads -aio -debug -ipv6 -libatomic -pcre-jit -rtmp (-selinux) -vim-syntax`
**FROM kubler/openssl** |
