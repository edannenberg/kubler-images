### kubler/nginx-php7:20210830

Built: Mon Aug 30 05:23:53 PM CEST 2021
Image Size: 134MB
...
media-gfx/imagemagick-7.1.0.4 | `bzip2 cxx jpeg jpeg2k png tiff webp zlib -`
...
x11-libs/libX11-1.7.2 | `-doc -ipv6 -test`
...
--------|----------
**FROM kubler/nginx** |
www-servers/nginx-1.21.1 | `http http-cache http2 pcre ssl threads -aio -debug -ipv6 -libatomic -pcre-jit -rtmp (-selinux) -vim-syntax`
**FROM kubler/openssl** |
