### kubler/nginx-php7:20200731

Built: Fri 31 Jul 2020 11:21:43 PM CEST
Image Size: 289MB
...
media-gfx/imagemagick-7.0.10.23 | `bzip2 cxx jpeg jpeg2k png tiff webp zlib -`
...
www-servers/nginx-1.19.1 | `http http-cache http2 pcre ssl threads -aio -debug -ipv6 -libatomic -libressl -luajit -pcre-jit -rtmp (-selinux) -vim-syntax`
**FROM kubler/openssl** |
