### kubler/nginx-php7:20221031

Built: Tue Nov  1 21:13:26 CET 2022
Image Size: 163MB
...
media-libs/tiff-4.4.0 | `cxx jpeg zlib -jbig -lzma -static-libs -test -verify-sig -webp -zstd`
...
sys-apps/systemd-utils-251.4-r2 | `acl kmod (split-usr) tmpfiles udev -boot (-selinux) -sysusers -test`
...
sys-libs/libcap-2.65 | `(split-usr) -pam -static-libs -tools`
...
www-servers/nginx-1.23.2-r1 | `http http2 http-cache pcre pcre2 ssl threads -aio -debug -libatomic -pcre-jit -rtmp (-selinux) -vim-syntax`
**FROM kubler/openssl** |
