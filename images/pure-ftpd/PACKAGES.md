### kubler/pure-ftpd:20230430

Built: Tue May  2 10:01:36 AM CEST 2023
Image Size: 30.4MB
...
net-ftp/pure-ftpd-1.0.51-r1 | `ssl vchroot -anondel -anonperm -anonren -anonres -caps -implicittls -ldap -mysql -noiplog -pam -paranoidmsg -postgres -resolveids (-selinux) -sysquota -xinetd`
#### Inherited
Package | USE Flags
--------|----------
**FROM kubler/openssl** |
