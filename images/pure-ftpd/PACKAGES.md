### kubler/pure-ftpd:20230131

Built: Wed Feb  1 12:35:19 AM CET 2023
Image Size: 30.2MB
...
net-ftp/pure-ftpd-1.0.51 | `ssl vchroot -anondel -anonperm -anonren -anonres -caps -implicittls -ldap -mysql -noiplog -pam -paranoidmsg -postgres -resolveids (-selinux) -sysquota -xinetd`
#### Inherited
Package | USE Flags
--------|----------
**FROM kubler/openssl** |
