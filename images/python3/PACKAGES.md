### kubler/python3:20221031

Built: Tue Nov  1 21:22:20 CET 2022
Image Size: 211MB
...
dev-lang/python-3.10.8_p1 | `ensurepip hardened readline sqlite ssl xml -bluetooth -build -examples -gdbm -libedit -lto -ncurses -pgo -test -tk -verify-sig`
...
dev-python/autocommand-2.2.1_p20211118 | `-test`
dev-python/certifi-3021.3.16-r2 | `-test`
dev-python/ensurepip-pip-22.2.2 | ``
dev-python/ensurepip-setuptools-65.2.0 | ``
dev-python/ensurepip-wheels-100 | ``
dev-python/inflect-6.0.0 | `-test`
dev-python/jaraco-context-4.1.2 | `-test`
dev-python/jaraco-functools-3.5.1 | `-test`
dev-python/jaraco-text-3.9.1 | `-test`
dev-python/more-itertools-8.14.0 | `-doc -test`
dev-python/nspektr-0.4.0 | `-test`
dev-python/ordered-set-4.1.0 | `-test`
dev-python/packaging-21.3-r2 | `-test`
dev-python/pip-22.2.2 | `(test-rust) -test -vanilla`
dev-python/pydantic-1.10.2 | `native-extensions -test`
dev-python/pyparsing-3.0.9 | `-examples -test`
dev-python/setuptools-65.3.0 | `-test`
dev-python/setuptools_scm-7.0.5 | `-test`
