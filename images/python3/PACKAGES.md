### kubler/python3:20220530

Built: Mon May 30 01:24:44 PM CEST 2022
Image Size: 311MB
...
dev-db/sqlite-3.38.2 | `readline -debug -doc -icu -secure-delete -static-libs -tcl -test -tools`
...
dev-python/importlib_metadata-4.11.3 | `-doc -test`
...
dev-python/nspektr-0.3.0 | `-test`
dev-python/ordered-set-4.1.0 | `-test`
dev-python/packaging-21.3-r2 | `-test`
dev-python/pip-22.0.4 | `-test -vanilla`
dev-python/pyparsing-3.0.7-r1 | `-examples -test`
dev-python/setuptools-62.1.0-r1 | `-test`
dev-python/setuptools_scm-6.4.2 | `-test`
dev-python/tomli-2.0.1 | `-test`
dev-python/zipp-3.8.0 | `-doc -test`
