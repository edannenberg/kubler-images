### kubler/python3:20230430

Built: Tue May  2 10:02:47 AM CEST 2023
Image Size: 212MB
...
dev-python/pip-23.0.1 | `(test-rust) -test`
dev-python/platformdirs-3.2.0 | `-test`
dev-python/pydantic-1.10.7 | `native-extensions -test`
dev-python/pyparsing-3.0.9 | `-examples -test`
dev-python/setuptools-67.6.1 | `-test`
