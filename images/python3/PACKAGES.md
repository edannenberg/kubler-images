### kubler/python3:20240430

Built: Thu May  2 11:56:47 PM CEST 2024
Image Size: 296MB
...
dev-lang/python-3.11.9 | `ensurepip readline sqlite ssl -bluetooth -build -debug -examples -gdbm -libedit -ncurses -pgo -test -tk -valgrind -verify-sig`
...
dev-python/backports-tarfile-1.1.1 | `-test`
dev-python/ensurepip-pip-24.0 | ``
dev-python/ensurepip-setuptools-69.5.1 | ``
...
dev-python/setuptools-69.5.1-r1 | `-test`
dev-python/setuptools-scm-8.0.4 | `-test`
dev-python/typing-extensions-4.11.0 | `-test`
