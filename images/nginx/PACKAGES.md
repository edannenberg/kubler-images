### kubler/nginx:20211130

Built: Thu Dec  2 03:37:20 PM CET 2021
Image Size: 29.3MB

#### Installed
Package | USE Flags
--------|----------
www-servers/nginx-1.21.4 | `http http2 http-cache pcre ssl threads -aio -debug -ipv6 -libatomic -pcre-jit -rtmp (-selinux) -vim-syntax`
#### Inherited
Package | USE Flags
--------|----------
**FROM kubler/openssl** |
