### kubler/log-collector:20240331

Built: Tue Apr  2 10:50:21 PM CEST 2024
Image Size: 539MB
...
app-crypt/gnupg-2.4.4-r1 | `bzip2 nls readline smartcard ssl tofu -doc -ldap (-selinux) -test -tools -tpm -usb -user-socket -verify-sig -wks-server`
...
dev-vcs/git-2.43.2 | `blksha1 curl gpg iconv nls pcre safe-directory webdav -cgi -cvs -doc -highlight -keyring -mediawiki -perforce -perl (-selinux) -subversion -test -tk -xinetd`
