### kubler/log-collector:20220430

Built: Sat Apr 30 09:35:57 CEST 2022
Image Size: 440MB
...
dev-lang/ruby-2.6.10 | `rdoc ssl -berkdb -debug -doc -examples -gdbm -ipv6 -jemalloc -jit -rubytests -socks5 -static-libs -systemtap -tk -xemacs`
...
dev-vcs/git-2.35.1 | `blksha1 curl gpg iconv nls pcre threads webdav -cgi -cvs -doc -emacs -gnome-keyring -highlight -mediawiki -mediawiki-experimental -perforce -perl (-ppcsha1) (-selinux) -subversion -test -tk -xinetd`
