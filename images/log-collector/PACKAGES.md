### kubler/log-collector:20230531

Built: Wed May 31 11:37:59 AM CEST 2023
Image Size: 525MB
...
dev-lang/ruby-3.0.6-r2 | `rdoc ssl -berkdb -debug -doc -examples -gdbm -ipv6 -jemalloc -jit -rubytests -socks5 -static-libs -systemtap -tk -valgrind -xemacs`
...
dev-ruby/minitest-5.18.0 | `-doc -test`
dev-ruby/pkg-config-1.5.1 | `-doc -test`
dev-ruby/power_assert-2.0.3 | `-doc -test`
dev-ruby/rake-13.0.6-r1 | `-doc -test`
dev-ruby/rbs-2.8.4 | `-doc -test`
...
dev-ruby/test-unit-3.5.7 | `-doc -test`
dev-ruby/typeprof-0.21.7 | `-test`
dev-util/pkgconf-1.8.1 | `-test`
dev-vcs/git-2.39.3 | `blksha1 curl gpg iconv nls pcre safe-directory webdav -cgi -cvs -doc -highlight -keyring -mediawiki -perforce -perl (-selinux) -subversion -test -tk -xinetd`
