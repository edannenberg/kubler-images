### kubler/nginx-php:20240630

Built: Sat Jul 20 04:42:43 AM CEST 2024
Image Size: 177MB
...
dev-lang/php-8.1.29 | `acl bcmath bzip2 calendar cli ctype curl fileinfo filter flatfile fpm gd iconv jit mhash mysql mysqli nls opcache pcntl pdo phar posix readline session simplexml soap sockets ssl tokenizer truetype unicode webp xml xmlreader xmlwriter xpm xslt zip zlib -apache2 -apparmor -argon2 -avif -berkdb -cdb -cgi -cjk (-coverage) -debug -embed -enchant -exif -ffi (-firebird) -ftp -gdbm -gmp -imap -inifile -intl -iodbc -ipv6 -kerberos -ldap -ldap-sasl -libedit -lmdb -mssql -oci8-instant-client -odbc -phpdbg -postgres -qdbm (-selinux) -session-mm -sharedmem -snmp -sodium -spell -sqlite -systemd -sysvipc -test -threads -tidy -tokyocabinet`
...
dev-libs/libxml2-2.12.7 | `ftp python readline -debug -examples -icu -lzma -static-libs -test`
...
media-gfx/imagemagick-7.1.1.25 | `bzip2 cxx jpeg jpeg2k png tiff webp zlib -`
...
net-misc/memcached-1.6.27 | `seccomp ssl -debug -sasl (-selinux) -slabs-reassign -test`
...
x11-libs/libX11-1.8.9 | `-doc -test`
