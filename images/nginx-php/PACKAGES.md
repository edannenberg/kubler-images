### kubler/nginx-php:20240430

Built: Thu May  2 11:27:28 PM CEST 2024
Image Size: 177MB
...
x11-libs/libxcb-1.16.1 | `xkb -doc (-selinux) -test`
...
www-servers/nginx-1.25.4-r1 | `http http2 http-cache pcre pcre2 ssl threads -aio -debug -http3 -ktls -libatomic -pcre-jit -rtmp (-selinux) -test -vim-syntax`
**FROM kubler/openssl** |
