### kubler/postgres:20230330

Built: Thu Mar 30 09:26:51 AM CEST 2023
Image Size: 117MB
...
dev-db/postgresql-15.2 | `nls readline server ssl threads zlib -debug -doc -icu -kerberos -ldap -llvm -lz4 -pam -perl -python (-selinux) -static-libs -systemd -tcl -uuid -xml -zstd`
sys-apps/kmod-30-r1 | `lzma (tools) zlib zstd -debug -doc -pkcs7 -python -static-libs`
sys-apps/less-608-r2 | `pcre unicode`
