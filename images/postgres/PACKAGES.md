### kubler/postgres:20200930

Built: Wed Sep 30 05:08:38 PM CEST 2020
Image Size: 80.1MB

#### Installed
Package | USE Flags
--------|----------
acct-group/postgres-0 | ``
acct-user/postgres-0 | ``
app-admin/su-exec-0.2 | `-static`
app-eselect/eselect-postgresql-2.4 | ``
app-misc/editor-wrapper-4-r1 | ``
dev-db/postgresql-12.4 | `nls readline server ssl threads zlib -debug -doc -icu -kerberos -ldap -libressl -llvm -pam -perl -python (-selinux) -static-libs -systemd -tcl -uuid -xml`
