### kubler/gulp-sass-gcc:20220430

Built: Sat Apr 30 09:26:08 CEST 2022
Image Size: 593MB
...
app-crypt/gnupg-2.2.34-r1 | `bzip2 nls readline smartcard ssl -doc -ldap (-selinux) -tofu -tools -usb -user-socket -verify-sig -wks-server`
app-crypt/gpgme-1.16.0 | `cxx -common-lisp -python -qt5 -static-libs -verify-sig`
...
dev-lang/python-3.10.4 | `hardened readline sqlite ssl xml -bluetooth -build -examples -gdbm -libedit -lto -ncurses -pgo -test -tk -verify-sig -wininst`
...
dev-libs/libxml2-2.9.13-r1 | `readline -debug -examples -icu -lzma -python -static-libs -test`
...
net-libs/nodejs-14.19.0 | `icu npm snapshot ssl system-icu system-ssl -debug -doc -inspector -lto -pax-kernel -systemtap -test`
