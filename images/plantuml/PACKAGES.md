### kubler/plantuml:20220430

Built: Sat Apr 30 09:53:20 CEST 2022
Image Size: 250MB
...
dev-libs/glib-2.70.4 | `elf mime xattr -dbus -debug -fam -gtk-doc (-selinux) -static-libs -sysprof -systemtap -test -utils`
dev-libs/libltdl-2.4.6 | `-static-libs`
dev-libs/libxml2-2.9.13-r1 | `python readline -debug -examples -icu -lzma -static-libs -test`
media-gfx/graphviz-2.49.0-r1 | `nls -`
...
dev-java/tomcat-native-1.2.32 | `-static-libs -test`
dev-java/tomcat-servlet-api-10.0.18 | `-source`
...
www-servers/tomcat-10.0.18 | `-doc -extra-webapps -source -test`
