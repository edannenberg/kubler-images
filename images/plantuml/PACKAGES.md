### kubler/plantuml:20201130

Built: Mon Nov 30 04:58:29 PM CET 2020
Image Size: 244MB
...
dev-java/tomcat-servlet-api-8.5.59 | `-source`
dev-libs/apr-1.7.0-r1 | `urandom -doc -older-kernels-compatibility (-selinux) -static-libs`
www-servers/tomcat-8.5.59 | `-doc -extra-webapps -source -test`
**FROM kubler/jre-openjdk** |
app-crypt/p11-kit-0.23.19-r1 | `asn1 libffi trust -debug -systemd`
