### kubler/plantuml:20230831

Built: Thu Aug 31 09:20:42 AM CEST 2023
Image Size: 266MB
...
dev-java/jakartaee-migration-1.0.7 | `-doc -source -test`
...
dev-java/tomcat-native-2.0.4 | `-doc -source -static-libs -test -verify-sig`
...
www-servers/tomcat-10.1.11 | `-doc -extra-webapps -source -test -verify-sig`
