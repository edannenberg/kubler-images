### kubler/plantuml:20200329

Built: Sun 29 Mar 2020 02:30:52 PM CEST
Image Size: 207MB
...
dev-libs/glib-2.60.7-r2 | `mime xattr -dbus -debug -fam -gtk-doc (-selinux) -static-libs -systemtap -test -utils`
...
dev-java/tomcat-servlet-api-8.5.51 | `-source`
dev-libs/apr-1.6.3-r4 | `urandom -doc -older-kernels-compatibility (-selinux) -static-libs`
www-servers/tomcat-8.5.51 | `-doc -extra-webapps -source -test`
